...
class VoiceChatbot:
    def __init__(self):
        self.cohere = cohere.Client("VZqzhiXR0JVntmqilXFqupar6zIkk7I6bTtRONJe")  # Replace with your actual Cohere API key
        self.elevenlabs = ElevenLabs(api_key="sk_55e214ab51abe09e4d3454bff6c3eb90de93bcc86f44e752")  # Replace with your actual ElevenLabs API key
    ...
    def think(self, text):
        response = self.cohere.chat(model="command-r7b-arabic-02-2025",message=text,temperature=0.7,max_tokens=200, preamble="جاوب بلهجة سعودية فقط، جاوب بشكل مختصر، اسمك هو المساعد الذكي وقد صممك عالية عمار نحاس  ")
